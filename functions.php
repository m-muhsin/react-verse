...
function reactverse_scripts() {
	...
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/inc/bootstrap.css', array(), REACTVERSE_VERSION );
...
require get_template_directory() . '/inc/custom_endpoints.php';
